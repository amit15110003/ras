				...
				<div class="m-form m-form--label-align-right">
					<div class="m-portlet__body">	
			            ...
			            <div class="m-form__section m-form__section--middle">
							...
							<div class="m-form__group form-group row">
								<label class="col-lg-2 col-form-label" for="exampleTextarea">Location:</label>
								<div class="col-lg-6">
									<textarea class="form-control m-input" name="b_desc" id="exampleTextarea" rows="3"></textarea>
								</div>
							</div>
							<div class="m-form__group form-group row">
