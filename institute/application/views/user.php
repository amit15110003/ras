				...
				<div class="m-form m-form--label-align-right">
					<div class="m-portlet__body">	
			            ...
			            <div class="m-form__section m-form__section--middle">
							...
							<div class="m-form__group form-group row">
								<label class="col-lg-2 col-form-label">RAS Number:</label>
								<div class="col-lg-6">
									<input type="text" class="form-control m-input" name="u_card" placeholder="">
								</div>
							</div>
							<div class="m-form__group form-group row">
								<label class="col-lg-2 col-form-label">Contact no:</label>
								<div class="col-lg-6">
									<input type="text" class="form-control m-input" name="u_contact" placeholder="">
								</div>
							</div>
							<div class="m-form__group form-group row">
								<label class="col-lg-2 col-form-label">Parent Contact no:</label>
								<div class="col-lg-6">
									<input type="text" class="form-control m-input" name="u_pcontact" placeholder="">
								</div>
							</div>
							<div class="m-form__group form-group row">
								<label class="col-lg-2 col-form-label">Email id:</label>
								<div class="col-lg-6">
									<input type="text" class="form-control m-input" name="u_mail" placeholder="">
								</div>
							</div>
							<div class="m-form__group form-group row">
							...
							<div class="m-form__group form-group row">
								...
								<div class="col-lg-6">
									<select class="form-control m-input" name="u_class" id="exampleSelect1">
